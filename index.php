...
<body>
	...
	<div class="row navbar content-title news-title" id="news">
		<div class="four columns centered">
			<h2 class="centered">News</h2>
		</div>
	</div>
	<div class="row navbar content news-content">
		<div class="four columns centered news-feed">
			...
			<div class="row">
				<div class="twelve columns news-entry">
					<h4>6/05/14 RECKLESS YOUTH RECORDING SINGLE</h4>
							...
							<div class="form-container active">
								<form action="">
									<div class="twelve columns centered">
										<ul>
											<li class="field">
												<input class="input seven  columns" placeholder="Card number" type="text" name="number">
												<input class="input four push_one columns" placeholder="CVC" type="text" name="cvc">
											</li>
											<li class="field">
												<input class="input three columns" id="first-name" placeholder="First name" type="text" name="first-name">
												<input class="input three push_one columns" id="last-name" placeholder="Last name" type="text" name="last-name">
												<input class="input four push_one columns" placeholder="MM/YY" type="text" name="expiry">
											</li>
											<li class="field">
												<input class="input eight columns" placeholder="Street Address" type="text" name="street">
												<input class="input three push_one columns" placeholder="City" type="text" name="city">
											</li>
											<li class="field">
	...
	<div class="row navbar content band-members">
		<div class="inview six columns centered band-members-list" gumby-classname="onscreen" gumby-offset="200">
			...
			<div class="four columns push_one band-members-list-members">
	...
	<script gumby-debug gumby-touch="js/libs" src="js/libs/gumby.js"></script>
